...
void main() => runApp(turple_pratik_py());

class turple_pratik_py extends StatefulWidget {
  @override
...
class _myAppState extends State<turple_pratik_py> {
          ...
          children: <Widget>[
            ...
            new Container(
                ...
                child: new Center(
                  child: Column(
                    children: <Widget>[
                      Text('Itilize turple sa pou fe egzesis yo \nturple1 = ["lekol", "legliz", "travay"]\n',
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            new Container(
                              ...
                              child: Text(
                                '1. print(len(turple1)) ap afiche kisa?',
                                style:
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            new Container(
                              padding: EdgeInsets.only(bottom: 3.0),
                              child: Text(
                                '2. print(turple1[2]) ap afiche kisa?) ',
                                style: TextStyle(
                                  fontSize: 18,
                                  color: Colors.teal,
                                ),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            new Container(
                              padding: EdgeInsets.only(bottom: 3.0),
                              child: Text(
                                '3. print(turple1[-2]) ap afiche kisa?',
                                style:
                                TextStyle(fontSize: 18, color: Colors.teal),
                              ),
                            ),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            new Container(
                              padding: EdgeInsets.only(bottom: 3.0),
                              child: Text(
                                '4. Afiche dezyem eleman an nan turple la.',
                                style:
                                TextStyle(fontSize: 18, color: Colors.teal),
                              ),
                            ),
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            new Container(
                              padding: EdgeInsets.only(bottom: 3.0),
                              child: Text(
                                '5. Afiche premye eleman an nan turple la.',
                                style:
                                TextStyle(fontSize: 18, color: Colors.teal),
                              ),
                            ),
  ...
  verifye() {
    ...
    String a2 = "travay";
    String a3 = "legliz";
    String a4 = "print(turple1[1])";
    String a5 = "print(turple1[0])";
    String a6 = "print(turple1)";
